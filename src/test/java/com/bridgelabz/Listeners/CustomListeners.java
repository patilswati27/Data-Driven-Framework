...
/**
 * @author swati
 * Purpose: To generate error logs and capture failed cases in
 *         script
 *
 */
public class CustomListeners extends TestBase implements ITestListener {
	...
	public void onTestStart(ITestResult arg0) {
		...
		/*
		 * if(!TestUtil.isTestRunnable(arg0.getName(),excel)) { throw new
		 * SkipException("Skiping the test "+arg0.getName().toUpperCase() ); }
		 */
	}
