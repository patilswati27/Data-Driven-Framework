...
public class TestBase {
	/*intialize 
	webdriver,properties,extentreports, 
	excel, mail,DB,reportNG
	logs:.log,log4j.properties file,logger.log */
	...
	public static ExcelReader excel=new ExcelReader(System.getProperty("user.dir")+"//src//test//resources//properties//excel//testData.xlsx");
